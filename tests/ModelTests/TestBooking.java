...
public class TestBooking {
    ...
    void setup() {
        ...
        event = new Event(ep, 1234, "Test Title", EventType.MUSIC, true);
        ...
        Collection<String> performerNames = new ArrayList<>(Arrays.asList("Performer 1", "Performer 2"));
        performance = new Performance(123, performanceStartTime, performanceEndTime, performerNames, 
    ...
    void testCancelByProvider(){
        ...
        assertEquals(booking.getStatus(), BookingStatus.CANCELLEDBYPROVIDER, "Expected true: Booking should be cancelled by provider");
    }
